...
benchDifferentQuadtrees = do
  ...
  let pmqTest = insertPointsPMQ (ul ++ ur ++ bl ++ br) "t" PMQ.empty
...
--  let !pmq1kkk2 = insertPointsPMQ points1kkk "t" PMQ.empty
--  let !mw1kkk = insertPointsMW points1kkk "t" MW.empty
--  let !rtw10kk = insertPointsRTW points10kk "t" RTW.empty
--
--  points100kkk <- generatePoints4Quadrants 25000000000
--  let !pmq100kkk = insertPointsPMQ points100kkk "t" PMQ.empty
--  let !pmq100kkk2 = insertPointsPMQ points100kkk "t" PMQ.empty
--  let !mw100kkk = insertPointsMW points100kkk "t" MW.empty
